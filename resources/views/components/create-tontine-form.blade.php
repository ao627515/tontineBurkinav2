                    ...
                    <form wire:submit="storeTontine" id="createTontine">
                        <div class="row row-cols-1">
                                ...
                                <div class="border border-secondary p-1 mb-3">
                                    <div class="bg-orange py-2" id="amount-contribution-taken">
                                        ...
                                        <h6 class="m-0 font-title text-center">
                                            <strong>{{ $tontineForm->amount * $tontineForm->number_of_members }}</strong>
                                            Franc cfa</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="col">
                                        <x-forms.input wire:model.live.debounce.500ms='tontineForm.amount'
                                            :group="[
                                                'class' => 'mb-3',
                                    ...
                                    <div class="col">
                                        <x-forms.input wire:model.live.debounce.500ms='tontineForm.number_of_members'
                                            :group="[
                                                'class' => 'mb-3',
                            ...
                            <div class="col">
                                <x-forms.textarea wire:model='tontineForm.description' :group="[
                                    'class' => 'mb-3',
                                ]"
                                    name="tontineForm.description" rows="3" :label="[
                                        'text' => 'Description',
                                        'class' => 'font-label',
                                    ]" />
                            </div>
